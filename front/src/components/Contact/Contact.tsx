...
const Contact = () => {
  return (
    <main>
      <div className="mx-auto mb-10 mt-10 w-full max-w-6xl rounded-3xl bg-secondary/50 pt-10">
        <div className="p-8">
            ...
            <div className="space-y-6 md:w-1/2">
              <div className="rounded-xl bg-secondary p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center">
                    <SquareArrowOutUpRight className="mr-2 h-6 w-6 text-primary" />
                    <span className="text-primary">
                      <a
              ...
              <div className="rounded-xl bg-quinary/15 p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center">
                    <Linkedin className="mr-2 h-6 w-6 text-primary" />
                    <a
